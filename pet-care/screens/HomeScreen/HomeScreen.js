...
import { View, ScrollView, StyleSheet, Image, FlatList, TouchableOpacity, Modal, TextInput, ActivityIndicator, Alert } from 'react-native';
...
{petData.length > 0 ? (
  <View style={styles.cardRow}>
    {petData.map((pet, index) => (
      <Card key={index} style={styles.petCard} onPress={() => navigation.navigate('Profile', { petId: pet.id })}>
        <Card.Content>
