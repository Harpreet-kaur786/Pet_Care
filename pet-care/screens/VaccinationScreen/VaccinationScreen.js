    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollViewContainer}>
        ...
        <View style={styles.imageContainer}>
          <Image
            source={require('../../assets/pet4.jpg')} // Replace with your image path
...
const styles = StyleSheet.create({
  ...
  imageContainer: {
    width: '100%',
    height: 200, // Image will cover 30% of the screen height
    marginTop: 20,
  },
  bannerImage: {
    width: '100%',
    height: '100%',
    resizeMode: 'contain', // Ensure the image covers the area proportionally
  },
  contentContainer: {
  ...
  backButton: {
    ...
    backgroundColor: '#000',
    borderRadius: 5,
    position: 'absolute', // Positioning it at the top left corner
